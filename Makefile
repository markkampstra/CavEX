...
BUILD		:=	build
SOURCES		:=	source source/block source/entity source/entity/mob source/graphics source/network source/game source/game/gui source/platform source/item source/item/items source/cNBT source/lodepng source/parson
DATA		:=
TEXTURES	:=	textures
INCLUDES	:=	extern
